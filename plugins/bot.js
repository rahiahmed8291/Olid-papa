...
module.exports = {
  ...
  start: async function ({ api, event, args }) {
    ...
    if (!usermsg) {
      const greetings = [
  "আহ শুনা আমার অলিদ বস এ তোমার অলিতে গলিতে উম্মাহ দেয় 😇😘",
  "কি গো সোনা আমাকে ডাকছ কেনো আমাকে না ডাকে আমার বস অলিদ কে ডাক ",
  "বার বার আমাকে ডাকস কেন😡",
  "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
  "হুম জান তোমার অইখানে  অলিদ বস এ উম্মমাহ দেয় 😷😘",
  "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
  "আমাকে এতো না ডেকে বস অলিদ-কে একটা জিএফ দে 🙄",
